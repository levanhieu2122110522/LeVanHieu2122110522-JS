...
// - Thêm số vào đầu và cuối (push, shift)

// - Xóa số đầu và cuối (pop, unshift)

// - Sắp xếp tăng dần sort

// - Lấy ra mảng con từ vị trị 3 đến 5 (slice)

// - Xóa phần tử plice()

// - Tìm vị trí đầu tiên phần tử indexOf

// - Tìm vị trí cuối cùng của phần tử lastIndexOf

// - Kiểm tra phân tử có trong mảng không includes
